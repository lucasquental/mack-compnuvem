                        ...
                        <div className="col-lg-9">
                            ...
                            <article>                
                                ...
                                <section className="mb-5">
                                    <h1 className="fw-bolder mb-1">SaaS - Prime Video</h1>
                                    ...
                                    <p className="fs-5 mb-4">Neste video, vemos como fazer uso da solução de SaaS para streaming de videos da Amazon, o Prime Video. A solução nos trás um catálogo enorme de opções de filmes e séries para consumo, podendo fazer a pesquisa e acesso desse conteúdo através de qualquer aparelho compatível e com acesso a internet.</p>
                                    <p className="fs-5 mb-4"></p>
                                    
                                    <h1 className="fw-bolder mb-1">SaaS - Office 365</h1>
